...
class _DeviceControlsState extends ConsumerState<DeviceControls> {
  static const double _selectButtonDiameterRatio = 0.40;
  static const double _buttonIconSizeRatio = 0.055;
  static const double _playPauseIconWidthRatio = 0.08;
  static const double _playPauseIconHeightRatio = 0.038;
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final double clickWheelDiameter = constraints.maxWidth >
                constraints.maxHeight
            ? constraints.maxHeight
            : constraints.maxWidth;
        final double selectButtonDiameter =
            clickWheelDiameter * _selectButtonDiameterRatio;
        final double buttonIconSize = clickWheelDiameter * _buttonIconSizeRatio;
        final Size playPauseIconSize = Size(
          clickWheelDiameter * _playPauseIconWidthRatio,
          clickWheelDiameter * _playPauseIconHeightRatio,
        );

        return GestureDetector(
          onPanUpdate: (dragUpdateDetails) => onClickWheelScroll(
            dragUpdateDetails: dragUpdateDetails,
            radius: clickWheelDiameter / 2,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: GestureDetector(
                        ...
                        child: SizedBox(
                          height: clickWheelDiameter * 0.35,
                          child: ColoredBox(
                            color: deviceColorStyle.controlBackgroundColor,
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: CustomPaint(
                                size: Size(buttonIconSize, buttonIconSize / 2),
                    ...
                    GestureDetector(
                      ...
                      onLongPressEnd: (_) async => ref
                          ...
                          .setDeviceAction(DeviceAction.longPressEnd),
                      child: SizedBox(
                        height: selectButtonDiameter,
                        width: selectButtonDiameter,
                        child: DecoratedBox(
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            border: Border.all(
