...
abstract class AppLocalizations {
  ...
  /// Title for the theme selection setting
  ///
  /// In en, this message translates to:
  /// **'Theme'**
  ...
  /// The name of the orange device color
  ///
  /// In en, this message translates to:
  /// **'Orange'**
  String get orangeDeviceColor;

  /// The name of the yellow device color
  ///
  /// In en, this message translates to:
  /// **'Yellow'**
  String get yellowDeviceColor;

  /// The name of the gold device color
  ///
  /// In en, this message translates to:
  /// **'Gold'**
  String get goldDeviceColor;

  /// The name of the purple device color
  ///
  /// In en, this message translates to:
  /// **'Purple'**
  String get purpleDeviceColor;

  /// The name of the pink device color
  ///
  /// In en, this message translates to:
  /// **'Pink'**
  String get pinkDeviceColor;

  /// The name of the brown device color
  ///
  /// In en, this message translates to:
  /// **'Brown'**
  String get brownDeviceColor;

  /// The name of the red device color
  ///
  /// In en, this message translates to:
  /// **'Red'**
  String get redDeviceColor;

  /// The name of the blue device color
  ///
  /// In en, this message translates to:
  /// **'Blue'**
  String get blueDeviceColor;

  /// The name of the lime device color
  ///
  /// In en, this message translates to:
  /// **'Lime'**
  String get limeDeviceColor;

  /// The name of the green device color
  ///
  /// In en, this message translates to:
  /// **'Green'**
  String get greenDeviceColor;
  ...
  /// Label for the option to edit the current song metadata
  ///
  /// In en, this message translates to:
  /// **'Edit Song'**
  String get editSongOption;

  /// Title for the song edit screen
  ///
  /// In en, this message translates to:
  /// **'Edit Song'**
  String get editSongScreenTitle;

  /// Label for editing the song title
  ///
  /// In en, this message translates to:
  /// **'Song Name'**
  String get editSongNameLabel;

  /// Label for editing artist names
  ///
  /// In en, this message translates to:
  /// **'Artist Names'**
  String get editSongArtistLabel;

  /// Label for editing the album name
  ///
  /// In en, this message translates to:
  /// **'Album Name'**
  String get editSongAlbumLabel;

  /// Label for editing the main genre
  ///
  /// In en, this message translates to:
  /// **'Genre'**
  String get editSongGenreLabel;

  /// Label for editing the lyrics text
  ///
  /// In en, this message translates to:
  /// **'Lyrics'**
  String get editSongLyricsLabel;

  /// Label for the button that saves edited song metadata
  ///
  /// In en, this message translates to:
  /// **'Save Changes'**
  String get saveChangesButton;

  /// The tutorial text for the click wheel when user is in input text bar screen for the first time
  ///
  /// In en, this message translates to:
  /// **'Move your thumb lightly around the Click Wheel to highlight a alphabet'**
  String get clickWheelInputTextBarTutorialText;

  /// The tutorial text for the center button when user is in input text bar screen for the first time
  ///
  /// In en, this message translates to:
  /// **'Press the center button to select the highlighted alphabet'**
  String get centerButtonInputTextBarScreenTutorialText;

  /// The tutorial text for the next button when user is in input text bar screen for the first time
  ///
  /// In en, this message translates to:
  /// **'Press this button to add a space'**
  String get nextButtonInputTextBarTutorialText;

  /// The tutorial text for the previous button when user is in input text bar screen for the first time
  ///
  /// In en, this message translates to:
  /// **'Press this button to delete the last character'**
  String get previousButtonInputTextBarTutorialText;

  /// The tutorial text for the menu button when user is in the input text bar screen for the first time
  ///
  /// In en, this message translates to:
  ...
  /// The title of the click wheel size setting
  ///
  /// In en, this message translates to:
  /// **'Click Wheel Size'**
  String get clickWheelSizeSettingTitle;

  /// The title of the click wheel sensitivity setting
  ///
  /// In en, this message translates to:
  /// **'Click Wheel Sensitivity'**
  String get clickWheelSensitivitySettingTitle;

  /// The text for small click wheel size
  ///
  /// In en, this message translates to:
  /// **'Small'**
  String get small;

  /// The text for medium click wheel size and sensitivity
  ///
  /// In en, this message translates to:
  /// **'Medium'**
  String get medium;

  /// The text for large click wheel size
  ///
  /// In en, this message translates to:
  /// **'Large'**
  String get large;

  /// The text for very low click wheel sensitivity
  ///
  /// In en, this message translates to:
  /// **'Very Low'**
  String get veryLow;

  /// The text for low click wheel sensitivity
  ///
  /// In en, this message translates to:
  /// **'Low'**
  String get low;

  /// The text for high click wheel sensitivity
  ///
  /// In en, this message translates to:
  /// **'High'**
  String get high;

  /// The title of the volume mode setting
  ///
  /// In en, this message translates to:
  /// **'Volume Mode'**
  String get volumeModeSettingTitle;

  /// The text for app volume mode
  ///
  /// In en, this message translates to:
  /// **'App'**
  String get appVolumeMode;

  /// The text for system volume mode
  ///
  /// In en, this message translates to:
  /// **'System'**
  String get systemVolumeMode;

  /// The text of the rename playlist option
  ///
  /// In en, this message translates to:
  /// **'Rename Playlist'**
  String get renamePlaylist;

  /// The title of the exclude directories screen
  ///
  /// In en, this message translates to:
  /// **'Exclude Directories'**
