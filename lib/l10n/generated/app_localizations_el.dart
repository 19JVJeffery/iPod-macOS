...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get lightThemeTitle => 'Φως';

  @override
  String get darkThemeTitle => 'Σκοτάδι';

  @override
  String get orangeDeviceColor => 'Πορτοκάλι';

  @override
  String get yellowDeviceColor => 'Κίτρινος';

  @override
  String get goldDeviceColor => 'Χρυσός';

  @override
  String get purpleDeviceColor => 'Μωβ';

  @override
  String get pinkDeviceColor => 'Ροζ';

  @override
  String get brownDeviceColor => 'Καστανός';

  @override
  String get redDeviceColor => 'Κόκκινος';

  @override
  String get blueDeviceColor => 'Μπλε';

  @override
  String get limeDeviceColor => 'Ασβεστος';

  @override
  String get greenDeviceColor => 'Πράσινος';
  ...
  @override
  String get editSongOption => 'Επεξεργασία τραγουδιού';

  @override
  String get editSongScreenTitle => 'Επεξεργασία τραγουδιού';

  @override
  String get editSongNameLabel => 'Όνομα τραγουδιού';

  @override
  String get editSongArtistLabel => 'Ονόματα καλλιτεχνών';

  @override
  String get editSongAlbumLabel => 'Όνομα άλμπουμ';

  @override
  String get editSongGenreLabel => 'Είδος';

  @override
  String get editSongLyricsLabel => 'Στίχοι';
  ...
  @override
  String get clickWheelSizeSettingTitle => 'Κάντε κλικ στο μέγεθος του τροχού';

  @override
  String get clickWheelSensitivitySettingTitle =>
      'Κάντε κλικ στην ευαισθησία του τροχού';
  ...
  @override
  String get high => 'Ψηλά';

  @override
  String get volumeModeSettingTitle => 'Λειτουργία έντασης ήχου';

  @override
  String get appVolumeMode => 'Εφαρμογή';

  @override
  String get systemVolumeMode => 'Σύστημα';

  @override
  String get renamePlaylist => 'Μετονομάστε τη λίστα αναπαραγωγής';

  @override
  String get excludeDirectoriesScreenTitle => 'Εξαιρέστε τους καταλόγους';
}
